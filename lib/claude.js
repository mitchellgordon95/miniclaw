...
export async function runClaude({
  ...
  const args = { prompt, channel, systemPrompt, sessionId, model, timeout, isolated, planMode, onDelta, onToolStart, onToolResult, onPlan };
...
async function _runClaude({
  prompt, channel, systemPrompt, sessionId, model, timeout, isolated, planMode, onDelta, onToolStart, onToolResult, onPlan,
}) {
  const config = loadConfig();
