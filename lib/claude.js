...
export async function runClaude({
  ...
  const args = { prompt, channel, systemPrompt, sessionId, model, timeout, isolated, planMode, onDelta, onToolStart, onToolResult };
...
async function _runClaude({
  prompt, channel, systemPrompt, sessionId, model, timeout, isolated, planMode, onDelta, onToolStart, onToolResult,
}) {
  const config = loadConfig();
